...
Answer: Why does this exist? If someone only reads this section, they should not
be confused.
...
A conceptual overview, not implementation detail. This is where diagrams belong,
if anywhere.
...
The shortest route from zero to "it works". No edge cases. No tuning. No yak
shaving.
